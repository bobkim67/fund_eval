...
const LABELS: { key: keyof Weights; label: string; color: string }[] = [
  ...
  { key: "yield_2y", label: "2년 수익률", color: "#107c41" },
  { key: "sharp_2y", label: "2년 샤프", color: "#bf6f00" },
  { key: "amc_sector_y", label: "운용사 점수", color: "#7c4dff" },
];

export function WeightsSlider({ weights, onChange, onHantoOptimal, onHantoSectorA, onHantoSectorB, onReset }: Props) {
